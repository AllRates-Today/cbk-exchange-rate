...
```javascript
{
  ...
  rate_date: '2026-08-11',   // Central Bank of Kuwait's own publication date
  source: 'USD',
  target: 'KWD',
  rate: 0.3071,
  rate_type: 'reference',
...
const series = await getHistory(
  { source: 'USD', target: 'KWD', from: '2026-01-01', to: '2026-08-11' },
  { apiKey: 'art_live_...' }
);
```
...
```javascript
{
  ...
  rates: [
    ...
    { date: '2026-08-11', rate: 0.3071, rate_type: 'reference', derived: false, method: 'published' },
    // …
  ],
  disclaimer: '…'
}
