# Central Bank of Kuwait Exchange Rate API — cbk-exchange-rate
...
Also published under the org scope as [`@allratestoday/cbk-exchange-rate`](https://www.npmjs.com/package/@allratestoday/cbk-exchange-rate) — same code, same versions.
...
```javascript
{
  ...
  rate_date: '2026-09-09',   // Central Bank of Kuwait's own publication date
  source: 'USD',
  target: 'KWD',
  rate: 0.30665,
  rate_type: 'reference',
...
```javascript
{
  ...
  rates: [
    { "base": "USD", "quote": "KWD", "type": "reference", "value": 0.30665 },
...
const series = await getHistory(
  { source: 'USD', target: 'KWD', from: '2026-01-01', to: '2026-09-09' },
  { apiKey: 'art_live_...' }
);
```
...
```javascript
{
  ...
  rates: [
    ...
    { date: '2026-09-09', rate: 0.30665, rate_type: 'reference', derived: false, method: 'published' },
    // …
  ],
  disclaimer: '…'
}
