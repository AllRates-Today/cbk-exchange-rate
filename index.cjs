'use strict';
// Central Bank of Kuwait exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbk';
...
/** Latest rate for one pair, e.g. getRate('USD', 'KWD', { apiKey }). */
